...
class ConsumerSecret extends Field
{
    ...
    protected function _getElementHtml(AbstractElement $element): string
    {
        try {
            ...
            if ($tokens) {
                ...
                return '<input type="text" readonly value="' . $this->escapeHtml($consumerSecret) . '" style="width: 100%; background: #f5f5f5;" onclick="this.select();" />';
            } else {
